...
<form action="index.php" method="post" class="w-50">
	...
	<div class="mb-3">
		...
		<input type="text" class="form-control" name="codigo" id="codigo"
			value="<?php echo htmlspecialchars($item->getCodigo()); ?>" readonly>
	</div>

	<div class="mb-3">
		<label for="nombre" class="form-label">Nombre</label>
		<input type="text" class="form-control" name="nombre" id="nombre"
			value="<?php echo htmlspecialchars(isset($_POST['nombre']) ? $_POST['nombre'] : $item->getNombre()); ?>">
	...
	<a class="btn btn-secondary" href="index.php?controlador=Item&accion=listar">Cancelar</a>
</form>
